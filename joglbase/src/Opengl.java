...
public class Opengl extends GLJPanel implements GLEventListener, KeyListener {
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        this.aspecto = (float) width / height;
        ...
        glu.gluPerspective(fovy, aspecto, 0.1, 20.0); // fovy, aspect, zNear, zFar
    ...
    public void keyPressed(KeyEvent e) {
        ...
        System.out.println("camX =" + this.camaraX + " - " + "camY =" + this.camaraY + " - " + "despZ =" + this.despZ);
    }
