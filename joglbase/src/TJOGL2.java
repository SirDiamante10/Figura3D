...
public class TJOGL2 extends GLJPanel implements GLEventListener, KeyListener {
   ...
   private static String TITLE = "JOGL";  // window's title
   ...
   float posCamaraX = 0.0f;
   float posCamaraY = 0.0f;
   float posCamZ = 0.0f;
   ...
   public void init(GLAutoDrawable drawable) {
      ...
      this.textura1 = this.cargarTextura("questionblock.png");
   ...
   public void display(GLAutoDrawable drawable) {
        ...
        glu.gluLookAt(0.0, 0.0, 5.0, this.posCamaraX, this.posCamaraY, this.posCamZ, 0.0, 1.0, 0.0);
        
        if (rotacionX<0) rotacionX=360-factInc;
        if (rotacionY<0) rotacionY=360-factInc;
        if (rotacionZ<0) rotacionZ=360-factInc;

        if (rotacionX>=360) rotacionX=0;
        if (rotacionY>=360) rotacionY=0;
        if (rotacionZ>=360) rotacionZ=0;

        // ----- Your OpenGL rendering code here (Render a white triangle for testing) -----

        gl.glRotatef(rotacionX, 1.0f, 0.0f, 0.0f);
        gl.glRotatef(rotacionY, 0.0f, 1.0f, 0.0f);
        gl.glRotatef(rotacionZ, 0.0f, 0.0f, 1.0f);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch(cod){
            ...
            case KeyEvent.VK_3:
                switch(eje){
                    case 1:
                        rotacionX+=factInc; break;
                    case 2:
                        rotacionY+=factInc; break;
                    case 3:
                        rotacionZ+=factInc; break;                        
                }
                break;
            case KeyEvent.VK_4:
                switch(eje){
        ...
        System.out.println("Typed="+e.getKeyCode()+", fovy="+fovy+", eje="+eje+" ,rotX="+rotacionX+" ,rotY="+rotacionY+" ,rotZ="+rotacionZ);
    }
